...
public class BezierCurve extends JPanel {
    ...
    public double blending(double u, int n, int k) {
        ...
        double result = coeff(n, k)*(Math.pow(u, k))*(Math.pow((1-u), (n-k)));
    ...
    public int coeff(int n, int k) {
        ...
        int factN = fact(n);
        int factK = fact(k);
        int factSubs = fact(n-k);
        int result = (factN)/(factK*factSubs);
        return result;
    }
    ...
    public static void main(String[] args) {
        ...
        bc.readObjectDescription("C:/Users/Usuario/Desktop/Universidad/7 SEMESTRE/Computacion-Grafica/Semana 12/BezierCurveStartingPoint/src/puntosControl.txt");
